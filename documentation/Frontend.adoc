...
For using Velocity components, in the `app`
should have `.npmrc` file with the content
...
Install necessary Velocity component
(list of published Velocity components:
https://nexus.leaseplan.io/#browse/browse:npm-internal:%40velocity)
